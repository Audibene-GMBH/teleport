...
func TestConnectionsLimiter(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		require.NotNil(t, limiter.AcquireConnection("token2"))
	}
...
func TestRateLimiter(t *testing.T) {
	...
	require.NotNil(t, limiter.RegisterRequest("token1"))
...
func TestCustomRate(t *testing.T) {
	...
	require.NotNil(t, limiter.RegisterRequestWithCustomRate("token1", customRate))
