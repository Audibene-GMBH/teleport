...
| `chartMode` | Guide |
| - | - |
| `standalone` | [Getting Started - Kubernetes with SSO](../../kubernetes-access/helm/guides/aws.mdx) |
...
`aws` settings are described in the AWS guide: [Running an HA Teleport cluster using an AWS EKS Cluster](../../kubernetes-access/helm/guides/aws.mdx)
...
<Admonition type="note" title="Installing cert-manager">
  ...
  and the relevant sections of the [AWS](../../kubernetes-access/helm/guides/aws.mdx#step-47-configure-tls-certificates-for-teleport) and [GCP](../../kubernetes-access/helm/guides/gcp.mdx#step-47-install-and-configure-cert-manager) guides for more information.
</Admonition>
...
<Admonition type="note" title="Configuring an Issuer">
  ...
  of the [AWS](../../kubernetes-access/helm/guides/aws.mdx#step-47-configure-tls-certificates-for-teleport) and [GCP](../../kubernetes-access/helm/guides/gcp.mdx#step-47-install-and-configure-cert-manager) guides for more information.
</Admonition>
