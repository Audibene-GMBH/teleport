...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](../../../setup/helm-reference/teleport-cluster.mdx#teleportversionoverride) value.
...
See the [high availability section of our Helm chart reference](../../../setup/helm-reference/teleport-cluster.mdx#highavailability) for more details on high availability.
